...
clermont =
    host "clermont" $ do
        props
            ...
            & httpsWebSite "sensei.app.pankzsoft.net" senseiWebConfig "contact@pankzsoft.net"
  ...
  where
    ...
    senseiWebConfig =
        ...
        , "    listen [::]:80;"
        , "    "
        , "    root /var/www/sensei.app.pankzsoft.net/public_html;"
        , "    index index.html index.htm index.nginx-debian.html;"
        , "    "
        , "    server_name sensei.app.pankzsoft.net;"
        , "    "
        , "    listen 443 ssl; # managed by Certbot"
        , ""
        , "    # RSA certificate"
        , "    ssl_certificate /etc/letsencrypt/live/sensei.app.pankzsoft.net/fullchain.pem; # managed by Certbot"
        , "    ssl_certificate_key /etc/letsencrypt/live/sensei.app.pankzsoft.net/privkey.pem; # managed by Certbot"
        , ""
        , "    include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot"
        , ""
        , "    # Redirect non-https traffic to https"
